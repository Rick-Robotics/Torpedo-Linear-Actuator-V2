...
/*  3-9-22 changed file name...
 *  3-11-22 added endstops and pot position.
 *  3-13-22 Compiled but failed to upload
 *  3-14-22 fixed upload problem.
 *    added serial terminal for debugging.
 *    buttons dont work. pot works, full range.
 *    motor only spins in one direction.
 *  9-9-22  Fixed Direction issue.
 *    This Version Works!!!
 *    Cleaned up code. 
 *    Using this as current version.  
 *    Saved working copy as V3. Resaved Experimental copy as V3a.
 *    Added Rotary Encoder for distance measurement.
 *    The motor works and encoder tells direction, but not position.
 *  9-12-22 This version works!
 *    ENC reading is limited by speed of ENC.
 *  1-24-23 Changed name to Torpedo_BTS7960_Driver_V4.
 *    Cleaned up code.
 *    THIS VERSION WORKS!!!  
